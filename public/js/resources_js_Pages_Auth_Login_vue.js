...
var _hoisted_2 = {
  "class": "bg-white p-8 rounded-xl max-w-3xl mx-auto border border-gray-500"
};
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  /* NEED_PATCH */
    ...
    "class": "text-red-500 text-sx mt-1"
  }, null, 8
  /* PROPS */
  ...
  , _hoisted_9)) : (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("v-if", true)]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", _hoisted_10, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("button", {
    type: "submit",
    "class": "bg-blue-400 text-white rounded py-2 px-4 hover:bg-blue-500 disabled:opacity-75",
